...
Company_data$under_t_point <- ifelse((Company_data$PC=="ESF")&(Company_data$Company=="SVE"),Company_data$Anchor - 16, Company_data$under_t_point)
...
Company_data$under_t_point_standardised <- ifelse((Company_data$PC=="ESF")&(Company_data$Company=="SVE"),Company_data$under_t_point / Company_data$s_factor,Company_data$under_t_point_standardised )
